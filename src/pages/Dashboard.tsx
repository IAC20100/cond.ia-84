  ...
  useEffect(() => {
    ...
    const checkStatus = async () => {
      try {
        ...
        const isFetchError = e.message?.toLowerCase().includes('fetch') || e.name === 'TypeError';
        
        // Only log as error if we've exhausted retries or it's not a simple fetch failure
